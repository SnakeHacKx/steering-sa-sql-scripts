...
ALTER PROC PROC_REGISTRAR_TIPO_SERVICIO(@Codigo INT, @Nombre VARCHAR(40),@Costo MONEY,@Descripcion VARCHAR(1500),@MsgSuccess VARCHAR(50)='' OUTPUT,@MsgError VARCHAR(50)='' OUTPUT)
AS
BEGIN
BEGIN TRAN
